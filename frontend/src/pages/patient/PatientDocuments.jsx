...
function PatientDocuments() {
  ...
  useEffect(() => {
    ...
    if (!selectedDocument || !file?.url || (!isPdf && !mime.startsWith('image/'))) return undefined
  ...
  }, [selectedDocument?.file?.url, selectedDocument?.file?.mime, selectedDocument?.id, t])
          ...
          <div className="space-y-4">
            ...
            {selectedDocument.file && (isImagePreview ? (
              previewUrl ? (
                ...
                <div className="bg-slate-100 rounded-xl min-h-48 flex items-center justify-center">
