                ...
                <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8 sm:p-10">
                    ...
                    <Section title="1. Общие положения">
                        <p>
                            ...
                            доступа к платформе медицинского туризма MedTour (далее — «Платформа»),
                            которая помогает пациентам организовать лечение в партнерских
                            медицинских организациях Казахстана.
                        </p>
                        <p>
                    ...
                    <Section title="2. Описание услуг">
                        ...
                        <ul className="list-disc pl-6 space-y-1.5">
                            <li>
                                ...
                                защищённый видеосеанс с врачом партнерской клиники
                                для первичной оценки медицинского случая.
                            </li>
                            <li>
                                <strong>Коммуникация по заявке</strong> —
                                письменный обмен сообщениями с командой сопровождения через чат Платформы.
                            </li>
                            <li>
                                <strong>Медицинские документы</strong> —
                                загрузка, хранение и передача документов для рассмотрения клиникой.
                            </li>
                        </ul>
                        <p className="mt-2">
                            Стоимость медицинских, сервисных и логистических услуг фиксируется
                            в плане лечения или коммерческом предложении.
                        </p>
                    </Section>
                        ...
                        <div className="space-y-4 text-slate-600 leading-relaxed">
                            ...
                            <div className="flex items-start gap-3 p-4 bg-blue-50 border border-blue-200 rounded-xl text-sm text-blue-800">
                                ...
                                <div>
                                    ...
                                    <p>
                                        Напишите на{' '}
                                        <a href="mailto:info@medtour.kz" className="underline font-medium">
                                            info@medtour.kz
                                        </a>{' '}
                    ...
                    <Section title="7. Разрешение споров">
                        ...
                        <ul className="list-disc pl-6 space-y-1.5">
                            <li>
                                ...
                                <a href="mailto:info@medtour.kz" className="text-teal-600 hover:underline">
                                    info@medtour.kz
                                </a>{' '}
                                или{' '}
