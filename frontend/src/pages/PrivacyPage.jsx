            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8 sm:p-10">
                    ...
                    <Section title="1. Общие положения">
                        <p>
                            Настоящая Политика конфиденциальности описывает, как MedTour
                            (далее — «Компания», «мы») собирает, использует и защищает персональные
                            данные пользователей платформы MedTour (medtour.nnmc.kz).
                        </p>
                        <p>
                    ...
                    <Section title="6. Хранение и удаление данных">
                        <p>
                            ...
                            По письменному запросу на info@medtour.kz мы удалим вашу учётную запись
                    ...
                    <Section title="9. Контакты">
                        ...
                        <ul className="list-none space-y-1.5 mt-2">
                            <li>📧 <strong>Email:</strong> info@medtour.kz</li>
