...
export const MEDICAL_CASE_TRANSITIONS = {
  ...
  CONSULTATION_COMPLETED: ['COMMISSION_REVIEW', 'CANCELLED'],
  COMMISSION_REVIEW: ['LOCAL_TREATMENT', 'TREATMENT_IN_KAZAKHSTAN', 'WAITING_FOR_DOCUMENTS', 'DOCTOR_ASSIGNED', 'CANCELLED'],
